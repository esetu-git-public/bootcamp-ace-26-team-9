...
This directory stores visual demonstrations and UI captures of the **Employee Attrition Prediction System**.

---

## 🖥️ Captured Views

When documenting your deployment or presenting to stakeholders, save screenshots in this directory with the following recommended names:

1. `01_login_portal.png` - Modern blue & white corporate authentication interface.
